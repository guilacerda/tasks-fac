...
.text
	...
	main:
		...
		li $v0, 34	# Carrega imediatamente a função 34 (impressão em hexadecimal) no registrador $v0
		move $a0, $t1 # Copia o valor setado no registrador $t1 para o primeiro argumento de retorno $a0
		syscall # Chama a função de ação solicitada anteriormente no registrador $v0 retornando o argumento $a0

		# Imprime o "\n"

		jal break_line # Pula para a label break_line armazenando o endereço atual

		# Imprime o valor armazenado no registrador $t2 na forma hexadecimal

		li $v0, 34 # Carrega imediatamente a função 34 (impressão em hexadecimal) no registrador $v0
		move $a0, $t2 # Copia o valor setado no registrador $t2 para o primeiro argumento de retorno $a0
		syscall # Chama a função de ação solicitada anteriormente no registrador $v0 retornando o argumento $a0
		...
		li $v0, 34 # Carrega imediatamente a função 34 (impressão em hexadecimal) no registrador $v0
		move $a0, $t3 # Copia o valor setado no registrador $t3 para o primeiro argumento de retorno $a0
		syscall # Chama a função de ação solicitada anteriormente no registrador $v0 retornando o argumento $a0
		...
		li $v0, 34 # Carrega imediatamente a função 34 (impressão em hexadecimal) no registrador $v0
		move $a0, $t4 # Copia o valor setado no registrador $t4 para o primeiro argumento de retorno $a0
		syscall # Chama a função de ação solicitada anteriormente no registrador $v0 retornando o argumento $a0
		...
		li $v0, 34 # Carrega imediatamente a função 34 (impressão em hexadecimal) no registrador $v0
		move $a0, $t5 # Copia o valor setado no registrador $t5 para o primeiro argumento de retorno $a0
		syscall # Chama a função de ação solicitada anteriormente no registrador $v0 retornando o argumento $a0

		jal end # Pula para a label end, finalizando o programa
	...
	break_line:
		...
		syscall # Chama a função de ação solicitada anteriormente no registrador $v0 retornando o argumento $a0
		jr $ra # Retorna para a posição de memória armazenada antes da chamada da label
